...
export const AfterDrawing = 'afterDrawing';
export const BeforeDrawing = 'beforeDrawing';
export const StartStabilizing = 'startStabilizing';
export const StabilizationIterationsDone = 'stabilizationIterationsDone';
