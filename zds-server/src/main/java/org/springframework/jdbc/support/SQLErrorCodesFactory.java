 ...
 * Reads the default file in this package if not   by a file in
...
public class SQLErrorCodesFactory {
  ...
  public SQLErrorCodes getErrorCodes(DataSource dataSource) {
    ...
    if (sec == null) {
      /**
       * Remove the global lock here as the JdbcUtils.extractDatabaseMetaData might block and then block other thread
       * that trying to compete for this lock
       * **/
