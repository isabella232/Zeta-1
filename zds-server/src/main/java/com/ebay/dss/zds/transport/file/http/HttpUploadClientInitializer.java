...
public class HttpUploadClientInitializer extends ChannelInitializer<SocketChannel> {
    ...
    public HttpUploadClientInitializer(SslContext sslCtx, ExceptionObserver exceptionObserver) {
        this.sslCtx = sslCtx;
    ...
    public void initChannel(SocketChannel ch) {
        ...
        pipeline.addLast("handler", new HttpUploadClientHandler(exceptionObserver));
    }
}
